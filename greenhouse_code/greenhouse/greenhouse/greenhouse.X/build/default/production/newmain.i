...
void Lcd_Port(char a) {
    if(a & 1) RD4 = 1; else RD4 = 0;
    if(a & 2) RD5 = 1; else RD5 = 0;
    if(a & 4) RD6 = 1; else RD6 = 0;
    if(a & 8) RD7 = 1; else RD7 = 0;
}
void Lcd_Cmd(char a) {
    RE0 = 0; Lcd_Port(a >> 4); RE1 = 1; _delay((unsigned long)((1)*(8000000/4000.0))); RE1 = 0;
    Lcd_Port(a); RE1 = 1; _delay((unsigned long)((1)*(8000000/4000.0))); RE1 = 0;
}
void Lcd_Clear(void) { Lcd_Cmd(0x01); _delay((unsigned long)((2)*(8000000/4000.0))); }
...
void Lcd_Init(void) {
    Lcd_Port(0x00); _delay((unsigned long)((20)*(8000000/4000.0)));
    Lcd_Cmd(0x03); _delay((unsigned long)((5)*(8000000/4000.0)));
    Lcd_Cmd(0x03); _delay((unsigned long)((11)*(8000000/4000.0)));
    Lcd_Cmd(0x03);
    Lcd_Cmd(0x02); Lcd_Cmd(0x28); Lcd_Cmd(0x0C); Lcd_Cmd(0x06);
    Lcd_Clear();
}
void Lcd_Write_Char(char a) {
    RE0 = 1; Lcd_Port(a >> 4); RE1 = 1; _delay((unsigned long)((1)*(8000000/4000.0))); RE1 = 0;
    Lcd_Port(a); RE1 = 1; _delay((unsigned long)((1)*(8000000/4000.0))); RE1 = 0;
}
...
void main(void) {
    ...
    while(1) {
        ...
        if (screen_page == 0) {
            ...
            Lcd_Set_Cursor(2, 1);
            if(RD0 == 1) Lcd_Write_String("Relay: ON       ");
